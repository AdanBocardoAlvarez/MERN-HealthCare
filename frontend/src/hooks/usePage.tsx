...
export function usePageData(pageData: IPageData) {
	...
	useEffect(() => { dispatch(setPageData({ ...pageData, loaded: true })) }, [pageData, dispatch]);
}

export function useFetchPageData<T>(url: string, initialState: T = null, callback?: (T) => any): [T, (data: T) => void] {
