...
const DisorderTrashTable = ({ nationalityTrash = [] }: Props) => {
  ...
  function restoreNationality(id) {
    ...
    AdminApi.RestorePatch(formData, 'disorders/restore', token)
      .then((datas) => {
  ...
  function deleteNationality(id: string) {
    AdminApi.tempDeleteBlog(`disorders/delete?id=${id}`, token)
      .then((datas) => {
        const message = datas.message;
  ...
  function deleteMultiNationality(id: string[]) {
    AdminApi.tempDeleteBlog(`disorders/multi-delete?id=${id}`, token)
      .then((datas) => {
        const message = datas.message;
        const status = datas.status;
        if (status) {
...
export default DisorderTrashTable;
