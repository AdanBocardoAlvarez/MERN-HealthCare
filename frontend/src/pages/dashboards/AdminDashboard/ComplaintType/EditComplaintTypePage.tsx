...
const EditComplaintTypePage = () => {
  ...
  const submitData = (data) => {
    ...
    AdminApi.createPatch(formData, 'complaint-type/edit', token)
      .then((datas) => {
        const message = datas.message;
        const status = datas.status;
        if (status) {
          openNotificationWithIcon({ type: 'success', message });
          Navigate('/admin/view-complaintType');
          reset();
        } else {
...
export default EditComplaintTypePage;
