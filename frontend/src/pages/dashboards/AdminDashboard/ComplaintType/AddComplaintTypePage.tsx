...
const AddComplaintTypePage = () => {
  ...
  const submitData = (data: IAdminPanel) => {
    ...
    AdminApi.createPost(formData, 'complaint-type/store', token)
      .then((datas) => {
              ...
              <Controller
                render={({ field }) => (
                  <Input
                    ...
                    aria-describedby='Enter Complaint Type'
                  />
                )}
                name='name'
                control={control}
...
export default AddComplaintTypePage;
