...
const ForgetPasswordPage = () => {
    ...
    const handelSubmit = (data: FormValues) => {
        ...
        ClientApi.postLogin(params, 'setting/forgot-password')
            .then((datas) => {
        ...
        <div className="row registration">
            <div className="col-lg-8 overflow-auto vh-100 scrollbar-none">
                <div className="container-lg p-5">
                    ...
                    <h1 className='h4'>{t('auth.forget-password')}</h1>
                    ...
                    <br />
                    <p>{t('auth.dont-have-acc')} <Link to='/public/client/sign-up'>{t('auth.sign-up')}</Link></p>
                </div>
            </div >
